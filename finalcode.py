...
image='C:\\Users\\salla\\Downloads\\icons8-alarm-100.png'
...
def sound_alarm():
    ...
    rad2=Radiobutton(frame_body, font=('arial 10 bold'), value=1, text="deactivate", bg=bg_color, command= deactivate_alarm, variable=selected)
